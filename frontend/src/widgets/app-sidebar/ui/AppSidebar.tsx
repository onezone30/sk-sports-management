...
import { User, Users, LayoutDashboard, LogOut, Menu, X, LogIn } from "lucide-react";
    ...
    return (
        <>
            <header className="sticky top-0 z-40 flex h-16 items-center justify-between border-b bg-white px-4 md:hidden">
                ...
                <Button size="icon" onClick={() => setOpen(true)} aria-label="Open sidebar menu">
                        ...
                        {links.map((item) => {
                            ...
                            return (
                                <NavLink
                                    ...
                                    onClick={closeSidebar}
                                    className={({ isActive }) =>
                                        `flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition ${isActive || (item.to !== "/" && location.pathname.startsWith(item.to))
                    ...
                    <div className="space-y-3 border-t pt-4">
                        {user ? (
                            <>
                                ...
                                <Button className="w-full justify-start gap-2" size="lg" onClick={handleLogout}>
